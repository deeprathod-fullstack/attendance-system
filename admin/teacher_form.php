...
if($_SESSION['is_login'] != true || $_SESSION['login_type'] != 'admin'){
   ...
   $date1 = date('Y-m-d');
		...
		if(isset($_GET["teacher_id"])) {
			$query1 = "SELECT * FROM `teacher` WHERE t_id=".$_GET['teacher_id'];
 ...
 ?>
    ...
    <div class="container-fluid">
      ...
      <div class="card shadow mb-4">
        ...
        <!-- Card Body -->
        <div class="card-body">
          <form class="user" method="POST" enctype="multipart/form-data" action="teacher_master.php">
		  
		  <?php if(isset($_GET["teacher_id"])) { ?>
		   <input type="hidden" name="t_id" value="<?php echo $row1["t_id"]; ?>" />
		  <?php } ?>
